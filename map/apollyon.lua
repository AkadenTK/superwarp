...
---------------------------------
    ...
    help_text = "| Apollyon |\n[sw] ap [warp/w] [all/a/@all/party/p] e1/nw1/sw2/ne5/se3 etc. -- warp to a designated tower and floor in apollyon. \n[sw] ap [all/a/@all/party/p] port -- warp to the next floor of any tower, if on last floor will warp to the entrance, if at entrance will warp to nw1. \n[sw] ap [all/a/@all/party/p] next -- warp to the first uncompleted floor in sequence, if this is in another tower, will warp to the entrance.\n [sw] ap [all/a/@all/party/p] back -- the reverse of port command, teleports to the previous floor. If you are on the first floor of a tower this will send you to the entrance, if you are at the entrance this command will send you to the last floor of the last tower. \n [sw] ap [all/a/@all/party/p] random -- Similar to the next command, sends you to floors you do not have the data for until you have collected all data; Will send you to other floors within the same tower until all are completed then will send to another tower/floor. \n [sw] ap [all/a/@all/party/p] enter -- enter apollyon. \n[sw] ap [all/a/@all/party/p] exit -- exit apollyon.\n------------------------------",
